...
export default function BlogPostHero({ post, ...other }) {
	...
	const pathCover = process.env.publitio_covers_folder + cover.url;
	const pathAvatar = process.env.publitio_avatars_folder + author.avatarUrl;

	return (
		<RootStyle {...other}>
			<CoverImgStyle alt="post cover" src={pathCover} />
